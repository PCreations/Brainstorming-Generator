var brainstorm = function(word) {
	...
	$('<span>Please wait, I\'m brainstorming for you...</span><br />'
			+'<img style="display:block; width: 400px; height: 400px; margin: auto; position: relative; top:-150px;" src="img/loading.gif" alt="loading" title="Chargement du Brainstorming en cours" />').appendTo($('#bsInfos'));
